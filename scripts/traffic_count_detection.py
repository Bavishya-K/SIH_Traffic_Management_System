...
model = YOLO('../models/yolov8s_count.pt')  # Adjust the path to your YOLOv8 model
...
def get_vehicle_counts_at_second(video_path, target_second=20):
    ...
    ret, frame = cap.read()
    if not ret:
        print("Failed to read the frame at the specified second.")
        cap.release()
        return None, None
    ...
    for bbox in bbox_ids:
        ...
        # Draw the bounding box and vertical line for visualization
